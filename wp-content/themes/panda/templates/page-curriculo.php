...
<section class="curriculo">
    <div class="container h-100">
        <div class="row align-items-center justify-content-center h-100 ">
            ...
            <?php $curriculo_resumido = get_field('curriculo_resumido'); ?>
            <?php $curriculo_completo = get_field('curriculo_completo'); ?>
            <?php $curriculo_comentado = get_field('curriculo_comentado'); ?>
            ...
            <div class="list-group download mt-4">
                <?php if ($curriculo_resumido) : ?>
                    ...
                    <a href="<?php echo esc_url( $curriculo_resumido['url'] ); ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" download="">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="26.089" height="36.257" viewBox="0 0 26.089 36.257">
